  ...
  return (
    <section className='py-32 bg-white w-full'>
      <div className='container w-full'>
        <h2 className='text-3xl lg:text-5xl font-medium text-center mb-4'>
          What Our Users Say
        </h2>
        <p className='text-center text-muted-foreground text-base mb-20'>
          Authentic experiences shared by our valued customers. See their
          ratings and feedback at a glance!
        </p>
      </div>
        <div className='flex justify-center items-center w-full'>
          <ScrollableComponent>
            {testimonials.map(testimonial => (
              <Card
                key={testimonial.id}
                className='shadow-xl rounded-xl shrink-0 max-w-xl  drop-shadow-xl bg-[#F6F6F6]'
              >
                ...
                <Rate
                  ...
                  className='mb-4'
                />
                <p className='text-gray-700 text-base font-light text-justify'>
                  {testimonial.comment}
                </p>
              </Card>
            ))}
