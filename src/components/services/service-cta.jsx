...
export function ServiceCTA({ title, description, buttonText = "Login" }) {
  return (
        ...
        <div className='mb-6 md:mb-0'>
          ...
          <div className='flex items-center w-full justify-between flex-wrap gap-8'>
            <p className='text-muted-foreground flex-1 text-base font-normal max-w-3xl mt-4'>
              {description || "Log in to explore our tailored Proppa House Property Viewing Packages and choose the one that suits you best. Let us handle the details while you make informed, stress-free decisions."}
            </p>
            <Button
              size='large'
