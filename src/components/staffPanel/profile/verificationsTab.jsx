    ...
    <>
      <div className='bg-white rounded-lg  border-2 border-[#b1b1b171]  p-6 mb-6'>
        ...
        <div className='bg-blue-50 p-4 border border-[#D3E6FF] rounded-lg mb-6'>
          <h3 className='text-[#2B4BB4] text-lg font-medium mb-2'>Required Documents</h3>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <VerificationCard
            ...
            submittedDate={verifications.photoId.submittedDate}
            verifiedDate={verifications.photoId.verifiedDate}
          ...
          <VerificationCard
            ...
            submittedDate={verifications.nationalInsurance.submittedDate}
            verifiedDate={verifications.nationalInsurance.verifiedDate}
...
<path d="M4 4C4 3.46957 4.21071 2.96086 4.58579 2.58579C4.96086 2.21071 5.46957 2 6 2H14C14.2652 2.00006 14.5195 2.10545 14.707 2.293L19.707 7.293C19.8946 7.48049 19.9999 7.73481 20 8V20C20 20.5304 19.7893 21.0391 19.4142 21.4142C19.0391 21.7893 18.5304 22 18 22H6C5.46957 22 4.96086 21.7893 4.58579 21.4142C4.21071 21.0391 4 20.5304 4 20V4ZM17.586 8L14 4.414V8H17.586ZM12 4H6V20H18V10H13C12.7348 10 12.4804 9.89464 12.2929 9.70711C12.1054 9.51957 12 9.26522 12 9V4ZM8 13C8 12.7348 8.10536 12.4804 8.29289 12.2929C8.48043 12.1054 8.73478 12 9 12H15C15.2652 12 15.5196 12.1054 15.7071 12.2929C15.8946 12.4804 16 12.7348 16 13C16 13.2652 15.8946 13.5196 15.7071 13.7071C15.5196 13.8946 15.2652 14 15 14H9C8.73478 14 8.48043 13.8946 8.29289 13.7071C8.10536 13.5196 8 13.2652 8 13ZM8 17C8 16.7348 8.10536 16.4804 8.29289 16.2929C8.48043 16.1054 8.73478 16 9 16H15C15.2652 16 15.5196 16.1054 15.7071 16.2929C15.8946 16.4804 16 16.7348 16 17C16 17.2652 15.8946 17.5196 15.7071 17.7071C15.5196 17.8946 15.2652 18 15 18H9C8.73478 18 8.48043 17.8946 8.29289 17.7071C8.10536 17.5196 8 17.2652 8 17Z" fill="#888888"/>
            ...
            submittedDate={verifications.references.submittedDate}
            verifiedDate={verifications.references.verifiedDate}
          ...
          <VerificationCard
            type='rightToWork'
            icon={
              <svg width="22" height="22" viewBox="0 0 22 22" className='size-5' fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M11 20.5C13.5196 20.5 15.9359 19.4991 17.7175 17.7175C19.4991 15.9359 20.5 13.5196 20.5 11C20.5 8.48044 19.4991 6.06408 17.7175 4.28249C15.9359 2.50089 13.5196 1.5 11 1.5C8.48044 1.5 6.06408 2.50089 4.28249 4.28249C2.50089 6.06408 1.5 8.48044 1.5 11C1.5 13.5196 2.50089 15.9359 4.28249 17.7175C6.06408 19.4991 8.48044 20.5 11 20.5Z" stroke="#888888" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M1.5 11H20.5M11 20.5C13.332 20.5 15.222 16.247 15.222 11C15.222 5.753 13.332 1.5 11 1.5C8.668 1.5 6.778 5.753 6.778 11C6.778 16.247 8.668 20.5 11 20.5Z" stroke="#888888" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            ...
            submittedDate={verifications.rightToWork.submittedDate}
            verifiedDate={verifications.rightToWork.verifiedDate}
