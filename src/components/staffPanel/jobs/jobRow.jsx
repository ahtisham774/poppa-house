...
const JobRow = ({ job, isAssigned,isHistory, onClick }) => {
  return (
    <div
          ...
          <div className='flex justify-between items-start '>
            ...
            <div className='flex items-center gap-2'>
              ...
              {!isAssigned && !isHistory && (
                <button className='w-fit p-2 border-2 gap-2 text-xs rounded-md font-medium flex items-center justify-center hover:bg-gray-50'>
                  <svg
                    width='18'
                    height='18'
                    viewBox='0 0 18 18'
