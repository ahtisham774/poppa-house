            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
              ...
              <label htmlFor={name} className="cursor-pointer">
                <div className="flex flex-col items-center">
                  ...
                  <p className="mt-2 text-sm text-gray-500">Drag and drop or click to browse files</p>
                </div>
              </label>
            </div>
            {value && <p className="mt-2 text-sm text-gray-500">{typeof value === 'string' ? value : value.name}</p>}
          </div>
        );
      default:
        return (
  ...
  return (
    <div className={`mb-4 ${className}`}>
      {type !== 'checkbox' && type !== 'radio' && label && (
        <label htmlFor={name} className="block mb-1 text-sm font-medium text-[#131e47]">
          {label}
