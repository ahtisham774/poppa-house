...
const StampDutyCalculator = () => {
  ...
  const handleCalculate = () => {
    ...
    const tax = calculateStampDuty(price, buyerType);
    setStampDuty(tax);
  };
  ...
  return (
    <div>
      <p className="text-gray-500 mb-6">
        Calculate the Stamp Duty Land Tax (SDLT) for your property purchase in England or Northern Ireland.
      </p>
      
      <div className="bg-blue-50 p-4 rounded-lg mb-6">
        <h3 className="text-primary font-semibold mb-2">Surcharges Applied Based on Buyer Type</h3>
        <ul className="text-primary text-sm space-y-1">
          <li>• Additional Property Buyers: +3% surcharge on each band</li>
          <li>• Non-UK Residents: +2% surcharge on each band (applies on top of the additional property surcharge, if applicable)</li>
          <li>• First-Time Buyers Relief:</li>
          <li className="ml-4">– 0% on the first £300,000</li>
          <li className="ml-4">– 5% on the portion between £300,001 and £500,000</li>
          <li className="ml-4">– Standard rates apply if the purchase exceeds £500,000</li>
        </ul>
        
        <h3 className="text-primary font-semibold mt-4 mb-2">Residential Property Tax Bands</h3>
      ...
      <div className="space-y-3 mb-6">
        <div className="flex items-center">
          ...
          />
          <label htmlFor="firstTime" className="ml-2 text-navy-900">First-Time Buyer</label>
        </div>
        ...
        <div className="flex items-center">
          <input
            ...
            className="h-5 w-5 text-primary"
          />
          <label htmlFor="additional" className="ml-2 text-navy-900">Additional Property (+3%)</label>
        </div>
        ...
        <div className="flex items-center">
          <input
            ...
            className="h-5 w-5 text-primary"
          />
          <label htmlFor="nonUK" className="ml-2 text-navy-900">Non-UK Resident (+2%)</label>
        </div>
      </div>
