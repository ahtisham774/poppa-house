...
import { getStatus } from './scheduleInfo'
    ...
    <>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3  gap-6 '>
        ...
        <div className='lg:col-span-1 sticky top-4 self-start'>
          <div className='mb-6 border rounded-lg border-[#E0E0E0] shadow-[0px_4px_4px_0px_#00000040]'>
            <div className=' flex items-center p-4  justify-center'>
              <h1 className='text-2xl font-medium'>Scheduled Date & Time</h1>
            </div>
            <div className='flex flex-col gap-4 border-t-2 border-b-2 p-4'>
              <MapLists
                list={[
                  {
                    label: 'Status',
                    value: getStatus('Date & Time Confirmed'),
                    isFullWidth: true
                  }
                ]}
              />
