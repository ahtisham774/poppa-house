...
import { FiUser, FiCalendar, FiChevronDown, FiChevronRight, FiChevronLeft } from "react-icons/fi"
      ...
      items.push(
        <button
          ...
          className={`w-10 h-10 flex items-center border border-gray-300 rounded-md justify-center ${
            currentPage === i ? "bg-primary text-white" : "bg-white text-gray-700 hover:bg-gray-100"
          }`}
        >
          {i}
        </button>,
      ...
      {visibleReviews.length === 0 ? (
        ...
        <>
          {visibleReviews.map((review) => (
            <div key={review.id} className="bg-white br rounded-lg p-6 mb-4 shadow-sm">
