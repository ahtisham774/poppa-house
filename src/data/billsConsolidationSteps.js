    ...
    fields: [
      {
        ...
        label:
          'Do you require assistance with setting up any of these services?',
        type: 'radio-group',
        options: [
      ...
      },
      {
        ...
        type: 'textarea',
        placeholder:
          'Please describe your specific requests e.g., existing provider details, custom billing preferences',
        rows: 4,
        full: true
      },
      {
        name: 'termsAgreed',
        label:
          'I confirm that the details provided are accurate and agree to the terms of service. An agent will get in touch with you within 5 working days.',
        type: 'checkbox',
        required: true
      }
    ]
...
export const propertyInsuranceSteps = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label:
          'Has the property experienced flooding, subsidence, or structural issues?',
        type: 'radio-group',
        full: true,
        inline: true,
        options: [
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        full: true,
        label:
          'I confirm that the details provided are accurate and agree to the terms and conditions. An agent will get in touch with you within 5 working days.',
        type: 'checkbox',
        required: true
      }
    ]
